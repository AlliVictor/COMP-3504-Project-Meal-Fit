     ...
     `;
        ...
        async function fetchAndDisplayMealPlan(restrictions) {
            ...
            try {
                ...
                const response = await fetch('https://35.208.93.54:8080/api/meals/plan', {
                    method: 'POST',
  ...
  function renderUsers() {
      ...
      document.getElementById('userForm').addEventListener('submit', async (e) => {
          ...
          try {
              ...
              const response = await fetch('https://35.208.93.54:8080/api/users/register', {
                  method: 'POST',
                  headers: { 'Content-Type': 'application/json' },
              ...
              if (response.ok) {
                  ...
                  const loginResponse = await fetch('https://35.208.93.54:8080/api/users/login', {
                      method: 'POST',
                      headers: { 'Content-Type': 'application/json' },
    ...
    function renderLogin() {
      ...
      `;
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('https://35.208.93.54:8080/api/users/login', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify(loginData),
                });
    ...
    function renderMealsTable() {
        ...
        async function fetchMeals() {
            try {
                ...
                const response = await fetch(`https://35.208.93.54:8080/api/search/meals`);
